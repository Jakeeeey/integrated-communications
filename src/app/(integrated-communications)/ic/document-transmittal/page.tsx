...
import DocumentTransmittalPage from "@/modules/integrated-communications/document-transmittal/DocumentTransmittalPage";
    ...
    return (
        <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
                        ...
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="#">IC</BreadcrumbLink>
                                </BreadcrumbItem>
            ...
            <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden p-2 sm:p-4 bg-muted/20">
                <DocumentTransmittalPage currentUser={headerUser} />
            </main>
        </div>
    );
}
